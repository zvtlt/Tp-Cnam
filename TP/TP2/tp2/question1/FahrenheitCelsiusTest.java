...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
	...
	public void test_fahrenheitEnCelsius2() {
		assertEquals("  252 °F -> 122.2 °C ? ", 122.2, question1.FahrenheitCelsius.fahrenheitEnCelsius(252), 0.1);
		assertEquals("  854 °F -> 456.6 °C ? ", 456.6, question1.FahrenheitCelsius.fahrenheitEnCelsius(854), 0.1);
	}
	...
	public void test_fahrenheitEnCelsius3() {
		assertEquals("24320 °F -> 13493.3 °C ?", 13493.3, question1.FahrenheitCelsius.fahrenheitEnCelsius(24320), 0.1);
