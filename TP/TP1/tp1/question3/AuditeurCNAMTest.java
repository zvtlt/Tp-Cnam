...
public class AuditeurCNAMTest extends junit.framework.TestCase {
    ...
    public void test_prenom_avec_accent() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("Bono",
                "Élise", "12345");
        assertEquals("Mme Bono Élise ", "Bono", auditeur1.nom());
        assertEquals("Mme Bono Élise ", "Élise", auditeur1.prenom());
        assertEquals(" prenom avec accent (É devient e) ? ", "bono_e", auditeur1.login());
    }
    
    public void test_prenom_court_avec_particule() {

        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("Petit",
                "jean-michel", "12345");
        assertEquals("Mr Petit jean-michel ", "Petit", auditeur1.nom());
        assertEquals("Mr Petit jean-michel ", "jean-michel", auditeur1.prenom());
        assertEquals("nom court avec particules ? ", "petit_j", auditeur1.login());
    }
}
